class Urls {
  ...
  static String sendPinCodeToEmail(email) => '$baseUrl/RecoverVerifyEmail/$email';
  static String verifyPinCode(String email, int otp) => '$baseUrl/RecoverVerifyOTP/$email/$otp';
