class Urls {
  ...
  static String cancelledTaskList(String status) => '$baseUrl/listTaskByStatus/$status';
  static String progressTaskList(String status) => '$baseUrl/listTaskByStatus/$status';
}